...
public:
    ...
    */
    ...
    {
        return const_cast
            <XMLNode*>(const_cast<const XMLNode*>(this)->LastChild());
    }
    ...
    */
    ...
    /** Accept a hierarchical visit of the nodes in the TinyXML DOM. Every node
       in the
...
public:
    ...
    */
    ...
    /** QueryIntAttribute interprets the attribute as an integer, and returns
       the value
...
public:
    ...
    */
    ...
    /** Given an attribute name, QueryIntAttribute() returns
        ...
        @verbatim
        int value = 10;
        QueryIntAttribute( "foo", &value );		// if "foo" isn't
       found, value will still be 10
        @endverbatim
    */
...
public:
    ...
    {
        return XMLConstHandle(_node ? _node->PreviousSiblingElement(_value)
                                    : 0);
    }
...
private:
    ...
    void PrintString(const char*, bool restrictedEntitySet); // prints out,
                                                             // after detecting
                                                             // entities.
