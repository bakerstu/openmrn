...
template <class IT> class StlIterator : public EventIterator
{
public:
    StlIterator()
    {
...
template <class IT> class StraightStlIterator : public StlIterator<IT>
{
public:
...
protected:
    ...
    ControlFlowAction WaitForGlobalReturn()
    {
        ...
        // Releases the iteration lock and yields to other control flows that
        // might
        // want it.
        event_handler_mutex.Unlock();
        return YieldAndCall(ST(StateInIteration));
