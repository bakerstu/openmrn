...
#define HSI_VALUE    ((uint32_t)16000000UL)           /*!< Value of the Internal oscillator in Hz*/
#endif /* HSI_VALUE */
...
#define LSI_VALUE  ((uint32_t)32000UL)                /*!< LSI Typical Value in Hz*/
...
#define LSE_VALUE    ((uint32_t)32768UL)              /*!< Value of the External oscillator in Hz*/
#endif /* LSE_VALUE */

#if !defined (LSE_STARTUP_TIMEOUT)
#define LSE_STARTUP_TIMEOUT    ((uint32_t)5000UL)     /*!< Time out for LSE start up, in ms */
...
#define EXTERNAL_I2S1_CLOCK_VALUE    ((uint32_t)48000UL) /*!< Value of the I2S1 External clock source in Hz*/
...
/**
  ...
  */
  ...
  #define EXTERNAL_I2S2_CLOCK_VALUE    ((uint32_t)48000U) /*!< Value of the I2S2 External clock source in Hz*/
...
/**
  ...
  */
#define  VDD_VALUE                    ((uint32_t)3300UL) /*!< Value of VDD in mv */
#define  TICK_INT_PRIORITY            ((uint32_t)((1UL<<__NVIC_PRIO_BITS) - 1UL)) /*!< tick interrupt priority */
#define  USE_RTOS                     0U
