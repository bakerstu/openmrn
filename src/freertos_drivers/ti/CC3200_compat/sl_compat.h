...
#define _FS_FILE_OPEN_FLAG_SECURE (SL_FS_CREATE_SECURE | SL_FS_OVERWRITE)
#define _FS_FILE_OPEN_FLAG_COMMIT SL_FS_CREATE_FAILSAFE
#define _FS_FILE_PUBLIC_WRITE (SL_FS_CREATE_PUBLIC_WRITE | SL_FS_CREATE_PUBLIC_READ)
...
#define SL_FS_ERR_INVALID_MAGIC_NUM SL_ERROR_FS_INVALID_MAGIC_NUM
...
#define SL_EBADF SL_ERROR_BSD_EBADF
/*#define  SL_ERROR_BSD
#define  SL_ERROR_BSD
#define  SL_ERROR_BSD
#define  SL_ERROR_BSD
