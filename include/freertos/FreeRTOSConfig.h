...
#define configCPU_CLOCK_HZ \
  ((unsigned long)48000000) /* =12Mhz xtal multiplied by 5 using the PLL. */
...
#define configCPU_CLOCK_HZ \
  ((unsigned long)96000000) /* =12Mhz xtal multiplied by 5 using the PLL. */
#define configMINIMAL_STACK_SIZE ((unsigned short)104)
#define configTOTAL_HEAP_SIZE ((size_t)(18 * 1024))
...
#define traceTASK_SWITCHED_IN()                                   \
  {                                                               \
    ...
    task_switched_in =                                            \
        (TaskSwitchedIn *)(prvGetTCBFromHandle(NULL)->pxTaskTag); \
