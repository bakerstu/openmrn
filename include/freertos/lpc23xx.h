...
#define CAN_LUT_ERR_ADR \
  (*(volatile unsigned int *)(CAN_ACCEPT_BASE_ADDR + 0x18))
...
#define GPDMA_RAW_INT_ERR_STAT \
  (*(volatile unsigned int *)(DMA_BASE_ADDR + 0x018))
...
/* Ethernet MAC (32 bit data bus) -- all registers are RW unless indicated in
 * parentheses */
#define MAC_BASE_ADDR 0xFFE00000 /* AHB Peripheral # 0 */
#define MAC_MAC1 \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x000)) /* MAC config reg 1 */
#define MAC_MAC2 \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x004)) /* MAC config reg 2 */
#define MAC_IPGT                                                            \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x008)) /* b2b InterPacketGap \
                                                         reg */
#define MAC_IPGR                                                 \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x00C)) /* non b2b \
                                                         InterPacketGap reg */
#define MAC_CLRT                                                   \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x010)) /* CoLlision \
                                                         window/ReTry reg */
#define MAC_MAXF \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x014)) /* MAXimum Frame reg */
#define MAC_SUPP \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x018)) /* PHY SUPPort reg */
#define MAC_TEST \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x01C)) /* TEST reg */
#define MAC_MCFG                                                             \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x020)) /* MII Mgmt ConFiG reg \
                                                         */
#define MAC_MCMD                                                              \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x024)) /* MII Mgmt CoMmanD reg \
                                                         */
#define MAC_MADR                                                              \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x028)) /* MII Mgmt ADdRess reg \
                                                         */
#define MAC_MWTD                                                             \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x02C)) /* MII Mgmt WriTe Data \
                                                         reg (WO) */
#define MAC_MRDD                                                            \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x030)) /* MII Mgmt ReaD Data \
                                                         reg (RO) */
#define MAC_MIND                                                             \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x034)) /* MII Mgmt INDicators \
                                                         reg (RO) */

#define MAC_SA0                               \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + \
                              0x040)) /* Station Address 0 reg */
#define MAC_SA1                               \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + \
                              0x044)) /* Station Address 1 reg */
#define MAC_SA2                               \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + \
                              0x048)) /* Station Address 2 reg */

#define MAC_COMMAND \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x100)) /* Command reg */
#define MAC_STATUS \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x104)) /* Status reg (RO) */
#define MAC_RXDESCRIPTOR                                                    \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x108)) /* Rx descriptor base \
                                                         address reg */
#define MAC_RXSTATUS                                                    \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x10C)) /* Rx status base \
                                                         address reg */
#define MAC_RXDESCRIPTORNUM                                           \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x110)) /* Rx number of \
                                                         descriptors reg */
#define MAC_RXPRODUCEINDEX                    \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + \
                              0x114)) /* Rx produce index reg (RO) */
#define MAC_RXCONSUMEINDEX                                                    \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x118)) /* Rx consume index reg \
                                                         */
#define MAC_TXDESCRIPTOR                                                    \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x11C)) /* Tx descriptor base \
                                                         address reg */
#define MAC_TXSTATUS                                                    \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x120)) /* Tx status base \
                                                         address reg */
#define MAC_TXDESCRIPTORNUM                                           \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x124)) /* Tx number of \
                                                         descriptors reg */
#define MAC_TXPRODUCEINDEX                                                    \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x128)) /* Tx produce index reg \
                                                         */
#define MAC_TXCONSUMEINDEX                    \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + \
                              0x12C)) /* Tx consume index reg (RO) */

#define MAC_TSV0                                                            \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x158)) /* Tx status vector 0 \
                                                         reg (RO) */
#define MAC_TSV1                                                            \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x15C)) /* Tx status vector 1 \
                                                         reg (RO) */
#define MAC_RSV                               \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + \
                              0x160)) /* Rx status vector reg (RO) */

#define MAC_FLOWCONTROLCNT                    \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + \
                              0x170)) /* Flow control counter reg */
#define MAC_FLOWCONTROLSTS                                                   \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x174)) /* Flow control status \
                                                         reg */

#define MAC_RXFILTERCTRL \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x200)) /* Rx filter ctrl reg */
#define MAC_RXFILTERWOLSTS                    \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + \
                              0x204)) /* Rx filter WoL status reg (RO) */
#define MAC_RXFILTERWOLCLR                                                   \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x208)) /* Rx filter WoL clear \
                                                         reg (WO) */

#define MAC_HASHFILTERL                                                       \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x210)) /* Hash filter LSBs reg \
                                                         */
#define MAC_HASHFILTERH                                                       \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0x214)) /* Hash filter MSBs reg \
                                                         */

#define MAC_INTSTATUS                         \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + \
                              0xFE0)) /* Interrupt status reg (RO) */
#define MAC_INTENABLE                         \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + \
                              0xFE4)) /* Interrupt enable reg  */
#define MAC_INTCLEAR                                                         \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0xFE8)) /* Interrupt clear reg \
                                                         (WO) */
#define MAC_INTSET                                                         \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0xFEC)) /* Interrupt set reg \
                                                         (WO) */

#define MAC_POWERDOWN \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0xFF4)) /* Power-down reg */
#define MAC_MODULEID \
  (*(volatile unsigned int *)(MAC_BASE_ADDR + 0xFFC)) /* Module ID reg (RO) */
