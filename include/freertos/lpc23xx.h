...
#define MAC_IPGT                                                               \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x008)) /* b2b InterPacketGap reg */
#define MAC_IPGR                                                               \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x00C)) /* non b2b InterPacketGap reg */
#define MAC_CLRT                                                               \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x010)) /* CoLlision window/ReTry reg */
#define MAC_MAXF                                                               \
...
#define MAC_MCMD                                                               \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x024)) /* MII Mgmt CoMmanD reg */
#define MAC_MADR                                                               \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x028)) /* MII Mgmt ADdRess reg */
#define MAC_MWTD                                                               \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x02C)) /* MII Mgmt WriTe Data reg (WO) */
#define MAC_MRDD                                                               \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x030)) /* MII Mgmt ReaD Data reg (RO) */
#define MAC_MIND                                                               \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x034)) /* MII Mgmt INDicators reg (RO) */
...
#define MAC_RXDESCRIPTOR                                                       \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x108)) /* Rx descriptor base address reg */
#define MAC_RXSTATUS                                                           \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x10C)) /* Rx status base address reg */
#define MAC_RXDESCRIPTORNUM                                                    \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x110)) /* Rx number of descriptors reg */
#define MAC_RXPRODUCEINDEX                                                     \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x114)) /* Rx produce index reg (RO) */
#define MAC_RXCONSUMEINDEX                                                     \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x118)) /* Rx consume index reg */
#define MAC_TXDESCRIPTOR                                                       \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x11C)) /* Tx descriptor base address reg */
#define MAC_TXSTATUS                                                           \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x120)) /* Tx status base address reg */
#define MAC_TXDESCRIPTORNUM                                                    \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x124)) /* Tx number of descriptors reg */
#define MAC_TXPRODUCEINDEX                                                     \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x128)) /* Tx produce index reg */
...
#define MAC_TSV0                                                               \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x158)) /* Tx status vector 0 reg (RO) */
#define MAC_TSV1                                                               \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x15C)) /* Tx status vector 1 reg (RO) */
#define MAC_RSV                                                                \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
...
#define MAC_RXFILTERWOLCLR                                                     \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x208)) /* Rx filter WoL clear reg (WO) */

#define MAC_HASHFILTERL                                                        \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x210)) /* Hash filter LSBs reg */
#define MAC_HASHFILTERH                                                        \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0x214)) /* Hash filter MSBs reg */
...
#define MAC_INTCLEAR                                                           \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0xFE8)) /* Interrupt clear reg (WO) */
#define MAC_INTSET                                                             \
    (*(volatile unsigned int*)(MAC_BASE_ADDR                                   \
                               + 0xFEC)) /* Interrupt set reg (WO) */
