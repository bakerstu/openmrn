#ifndef _APPLICATIONS_TIME_CLIENT_TARGET_CONFIG_HXX_
#define _APPLICATIONS_TIME_CLIENT_TARGET_CONFIG_HXX_
...
extern const SimpleNodeStaticValues SNIP_STATIC_DATA = {
    4,               "OpenMRN", "Time client test (linux)",
    "linux.x86", "1.01"};
...
static constexpr uint16_t CANONICAL_VERSION = 0x1234;


/// Defines the main segment in the configuration CDI. This is laid out at
/// origin 128 to give space for the ACDI user data at the beginning.
CDI_GROUP(ConfigSegment, Segment(MemoryConfigDefs::SPACE_CONFIG), Offset(128));
...
CDI_GROUP_ENTRY(seg, ConfigSegment);
...
#endif // _APPLICATIONS_TIME_CLIENT_TARGET_CONFIG_HXX_
