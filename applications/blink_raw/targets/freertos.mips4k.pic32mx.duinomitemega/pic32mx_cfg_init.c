...
unsigned int cfg_words[4] __attribute__((section("PIC32MX_cfg_init"))) = {
    ...
    0x6EF00FF4 |  // all unused bits remain set to '1', except high bit required
                  // 0
        ...
        0x00FFF000 |  // Disabled (all sectors writable; subsets can be
                      // protected...)
        ...
        //  0x00000002 | // Enabled - Background debug events branch to
        // 0xbfc0480
        //               //         - Do NOT enable this except for debug tools
        // that
        //               //           specifically require it, otherwise your
        // device
