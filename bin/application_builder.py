...
class App:
    ...
    def __init__(self, master):
        ...
        self.OpenmrnLabel = Label(frame, text="OpenMRN Path",
                                  font="Arial 12 bold")
        self.OpenmrnLabel.grid(row=ROW, column=0, sticky=S+W, padx=10)
        ...
        self.OpenmrnPath.grid(row=ROW+1, column=0, sticky=E+W, padx=5, pady=(0,20))
        ...
        self.ApplLabel = Label(frame, text="New Application Path",
                               font="Arial 12 bold")
        self.ApplLabel.grid(row=ROW, column=1, sticky=S+W, padx=10)
        self.ApplPath = Entry(frame, width=64)
        self.ApplPath.grid(row=ROW+1, column=1, sticky=E+W, padx=5, pady=(0,20))
        ...
        self.SubdirLabel = Label(frame, text="Application Subdirectory List [space separated]",
                                 font="Arial 12 bold")
        self.SubdirLabel.grid(row=ROW, column=0, sticky=S+W, padx=10)
        self.SubdirEntry = Entry(frame, width=64)
        self.SubdirEntry.grid(row=3, column=0, sticky=E+W, padx=5, pady=(0,20))
        ...
        self.Eclipse = Checkbutton(frame, text="Generate Eclipse Project",
                                   variable=self.EclipseVal, state=['selected'])
        self.Eclipse.grid(row=2, rowspan=2, column=1, sticky=W, padx=5)
        ...
        self.TargetLabel.grid(row=4, column=0, sticky=S+W, padx=10)
        self.LinuxX86Val = IntVar()
        self.LinuxX86Val = Checkbutton(frame, text="linux.x86",
                                       variable=self.LinuxX86Val,
                                       state=['!selected'])
        self.LinuxX86Val.grid(row=5, column=0, sticky=W, padx=5)
        self.LinuxX86Val = IntVar()
        self.LinuxX86Val = Checkbutton(frame, text="linux.x86",
                                       variable=self.LinuxX86Val,
                                       state=['!selected'])
        ...
        self.Ektm4c123gxl = Checkbutton(frame, text="ek-tm4c123gxl",
                                       ...
                                       state=DISABLED)
        self.Ektm4c123gxl.grid(row=8, column=0, sticky=W, padx=25)
        ...
        self.Ektm4c1294xl = Checkbutton(frame, text="ek-tm4c1294xl",
                                       ...
                                       state=DISABLED)
        self.Ektm4c1294xl.grid(row=9, column=0, sticky=W, padx=25)
        createToolImage(self.Ektm4c1294xl, "images/ek-tm4c1294xl.gif")

        # Quit Button
        self.Exit = Button(frame, text="Quit", command=frame.quit)
        self.Exit.grid(row=20, column=2, columnspan=2, sticky=S+E, padx=5, pady=5)

        # Generate Button
        self.Generate = Button(frame, text="Generate", command=frame.quit)
        self.Generate.grid(row=20, column=1, columnspan=1, sticky=S+E, padx=5, pady=5)
